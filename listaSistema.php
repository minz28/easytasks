...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <button type="button" class="btn btn-default btnNaranja" data-toggle="modal" data-target="#modalAdd"><span class="glyphicon glyphicon-plus"></span>  Agregar sistema</button><br><br>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">            
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Ingresar nuevo sistema</h4>
                ...
                <div class="modal-body">
                    <form id="form">
                        ...
                        <div class="form-group">
                            <label for="txtDescripcion">Sistema (*)</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" onclick="validaCrearSistema();">Grabar</button>
                </div>                
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="modalEdit" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 id="nombreTarea" class="modal-title">Editar sistema</h4>
                </div>
                <div class="modal-body">
                    <form id="formEdit">
                        ...
                        <div class="form-group">
                            <label for="txtDescripcion">Sistema (*)</label>
                            <input type="text" class="form-control" id="txtDescripcionEdit" name="txtDescripcionEdit" placeholder="Descripción sistema">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" onclick="guardaEditaSistema()">Grabar</button>
                </div>                
            </div>
        </div>
    </div>
