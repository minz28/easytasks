...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <button type="button" class="btn btn-default btnNaranja" data-toggle="modal" data-target="#modalAdd"><span class="glyphicon glyphicon-plus"></span>  Agregar area</button><br><br>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">            
